...
struct Z_Construct_UClass_AMyActorTest_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AMyActorTest_DemostrateFundamentals, "DemostrateFundamentals" }, // 1042762467
	};
...
struct Z_CompiledInDeferFile_FID_Users_PC_Documents_GitHub_UnrealEngineCArdenGGO_UECArdenGGO_Source_UECArdenGGO_MyActorTest_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMyActorTest, AMyActorTest::StaticClass, TEXT("AMyActorTest"), &Z_Registration_Info_UClass_AMyActorTest, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyActorTest), 958978969U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_PC_Documents_GitHub_UnrealEngineCArdenGGO_UECArdenGGO_Source_UECArdenGGO_MyActorTest_h_2781491319(TEXT("/Script/UECArdenGGO"),
